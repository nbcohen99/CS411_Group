(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DatabaseComponent = /** @class */ (function () {
                function DatabaseComponent(userService) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(router, redirect, socialAuthService, http, userService) {
                    this.router = router;
                ...
                LoginComponent.prototype.signinWithGoogle = function () {
                    ...
                    this.socialAuthService.signIn(socialPlatformProvider)
                        ...
                        _this.sendToRestApiMethod(userData.idToken);
                        console.log(userData);
                        //check to see if the user currently exists in the database, if not, add it to database.
                        _this.userService.getUserByID(userData.id).subscribe(function (users) {
                            if (users.length == 0) {
                ...
                LoginComponent.prototype.sendToRestApiMethod = function (idToken) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserService = /** @class */ (function () {
                ...
                UserService.prototype.toString = function () {
                    return "";
                };
